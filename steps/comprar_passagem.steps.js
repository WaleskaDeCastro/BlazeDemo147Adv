...
Given('que estou no site Blazedemo', async function (){
    await this.page.goto(this.homePage.url);  
    const screenshot = await this.page.screenshot({fullPage: true}); // captura um screenshot
    await this.attach(screenshot, 'image/png'); // anexa o screenshot ao relatório do Cucumber
